...
var ALIMiniAdapter=(function(){
	...
	ALIMiniAdapter.init=function(isPosMsg,isSon){
		...
		if(!ALIMiniAdapter.isZiYu){
			...
			MiniFileMgr$5.existDir(MiniFileMgr$5.fileNativeDir,Handler.create(ALIMiniAdapter,ALIMiniAdapter.onMkdirCallBack));
		}
...
var MiniFileMgr$5=(function(){
	...
	__class(MiniFileMgr,'laya.ali.mini.MiniFileMgr',null,'MiniFileMgr$5');
...
var MiniImage$5=(function(){
	function MiniImage(){}
	__class(MiniImage,'laya.ali.mini.MiniImage',null,'MiniImage$5');
...
var MiniInput$5=(function(){
	function MiniInput(){}
	__class(MiniInput,'laya.ali.mini.MiniInput',null,'MiniInput$5');
...
var MiniLocalStorage$5=(function(){
	...
	__class(MiniLocalStorage,'laya.ali.mini.MiniLocalStorage',null,'MiniLocalStorage$5');
...
var MiniLocation$5=(function(){
	...
	__class(MiniLocation,'laya.ali.mini.MiniLocation',null,'MiniLocation$5');
...
var MiniVideo$3=(function(){
	...
	__class(MiniVideo,'laya.ali.mini.MiniVideo',null,'MiniVideo$3');
...
var MiniAccelerator$5=(function(_super){
	...
	__class(MiniAccelerator,'laya.ali.mini.MiniAccelerator',_super,'MiniAccelerator$5');
...
var MiniLoader$5=(function(_super){
	...
	__class(MiniLoader,'laya.ali.mini.MiniLoader',_super,'MiniLoader$5');
	...
	*/
	__proto.load=function(url,type,cache,group,ignoreCache){
		...
		if ((MiniLoader._fileTypeArr.indexOf(urlType)!=-1)|| type==/*laya.net.Loader.IMAGE*/"image"){
			...
			if(ALIMiniAdapter.isZiYu && !MiniFileMgr$5.ziyuFileData[url]){
				url=URL.formatURL(url);
			}
			if(ALIMiniAdapter.isZiYu && MiniFileMgr$5.ziyuFileData[url]){
			...
			if (!MiniFileMgr$5.getFileInfo(url)){
				...
				MiniFileMgr$5.readFile(nativepath,fileObj.encoding,new Handler(MiniLoader,MiniLoader.onReadNativeCallBack,[encoding,url,type,cache,group,ignoreCache,thisLoader]),url);
			}
		}
	}
...
var MiniSound$5=(function(_super){
	...
	__class(MiniSound,'laya.ali.mini.MiniSound',_super,'MiniSound$5');
	...
	*/
	__proto.load=function(url){
		...
		if(ALIMiniAdapter.autoCacheFile&&MiniFileMgr$5.getFileInfo(url)){
	...
	*/
	__proto.play=function(startTime,loops){
		...
		if(ALIMiniAdapter.autoCacheFile&&MiniFileMgr$5.getFileInfo(this.url)){
			var fileNativeUrl;
...
var MiniSoundChannel$5=(function(_super){
	...
	__class(MiniSoundChannel,'laya.ali.mini.MiniSoundChannel',_super,'MiniSoundChannel$5');
